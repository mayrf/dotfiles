om+title: Emacs From Scratch Configuration
...
I am using the [[https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/FiraCode][FiraCode Nerd Font]] and [[https://www.cufonfonts.com/font/bookerly][Bookerly]] fonts for this configuration which will more than likely need to be installed on your machine.  Both can usually be found in the various Linux distro package managers or downloaded from the links above.
