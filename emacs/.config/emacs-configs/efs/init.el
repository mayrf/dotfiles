...
;; Make ESC quit prompts
  ...
  (use-package general
    :after evil
    :config
   (general-evil-setup t) ;; (?) from DT's config
  ...
  (use-package evil
    ...
    ;;(define-key evil-insert-stmap (kbd "C-h") 'evil-delete-backward-char-and-join)
  ...
  (use-package evil-collection
    :after evil
    :config
    (setq evil-collection-mode-list '(dashboard dired ibuffer));; (?) from DT's config
...
(efs/leader-keys
       ...
       "m m"   '(org-emphasize :which-key "Org emphasize")
